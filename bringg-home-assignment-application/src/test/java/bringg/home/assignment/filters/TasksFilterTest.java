...
public class TasksFilterTest {
    ...
    public void test1() {
        ...
        result = identicalPointsFilter.filter(result, distanceMatrix);

        assertNotNull(result);
        assertEquals(result.size(), 3);
        assertEquals(result.get(0), task2);
        assertEquals(result.get(1), task3);
        assertEquals(result.get(2), task6);
    ...
    public void test2() {
        ...
        result = doubleTasksFilter.filter(result, distanceMatrix);
